...
def train(
    ...
    def evaluate(parts):
        ...
        for part in parts:
            ...
            for idx in loader:
                pred_num, pred_cat = apply_model(part, idx)
                ...
                if pred_cat:
                    ...
                    target_cat = None
                    mask_cat = None
                pretrain_losses.append(loss_fn(pred_num, pred_cat, target_num, target_cat, mask_num, mask_cat).item())
    ...
    def step_fn(idx):
        pred_num, pred_cat = apply_model("train", idx)
        ...
        if pred_cat:
            ...
            target_cat = None
            mask_cat = None
        return pred_num, pred_cat, target_num, target_cat, mask_num, mask_cat


    def loss_fn(pred_num, pred_cat, target_num, target_cat, mask_num, mask_cat):
